...
- User uploads or provides a `.pptx` and wants to add 3D models
- User wants to add 3D models and Morph animations to an existing PPT
...
- For additional inspiration, browse `{baseDir}/../morph-ppt/reference/styles/INDEX.md` — 50+ visual styles organized by mood (dark, light, warm, vivid, bw). Read `style.md` for design philosophy, `build.sh` for implementation reference. **Learn the approach, do not copy coordinates verbatim**
